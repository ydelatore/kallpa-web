...
<html lang="es">
    ...
    <body>
        ...
        <section class="contenedor" id="informativo">
            ...
            <article class="caja-informativo lt-25" id="info1">
            ...
            <article class="caja-informativo lt-25" id="info2">
            ...
            <article class="caja-informativo lt-25" id="info3">
            ...
            <article class="caja-informativo lt-25" id="info4">
                <h3 class="titulo-informativos"><?php echo $titulo_info4; ?></h3>
                
                <p><?php echo $resumen_info4; ?></p>
                
                <div class="btn-leer"><a class="informativo-amplio" href="#info-amplio4">Leer más</a></div>
                
                <div class="video-informativo">
                    <?php echo $video_info4; ?>
                </div>
            </article>
            <div style="display:none;">
                <div class="informativo-amplio" id="info-amplio4">
                    <div class="video-informativo">
                        <?php echo $video_info4; ?>
                    </div>
